...
import { AutenticarUser } from '../../servicios/Usuarios';

export function IniciarSesion({setCrearUsuario,setLogin,SetSesion,SetDatosUsuario}){
    ...
    const Autenticar = async () =>{
        ...
        const solicitud = await AutenticarUser(User)
        if(solicitud.message === 200){
            SetDatosUsuario(solicitud.user)
            SetSesion(true)
        }
        else alert("Inicio de sesion denegado")
    }

    return(
        <div className="form_container">
                <div className="logo_container">
                    <img src={imagen} alt="Logo" height={90} />
                </div>
                ...
                <div className="input_container">
                    ...
                    <input placeholder="name@mail.com" value={email} onChange={(e) => setEmail(e.target.value)} title="Inpit title" name="input-name" type="text" className="input_field" id="email_field"/>
                </div>
                <div className="input_container">
                    ...
                    <input placeholder="Password" value={pass} onChange={(e) => setPass(e.target.value)} title="Inpit title" name="input-name" type="password" className="input_field" id="password_field"/>
                </div>
                <button title="Sign In" type="submit" className="sign-in_btn" onClick={Autenticar}>
                ...
                <button title="Sign In" type="submit" className="sign-in_ggl" onClick={() => {setCrearUsuario(true); setLogin(false)}}>
